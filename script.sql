...
-------------------------- FABRICIO UPDATE 25/08 DATAS

ALTER TABLE TB_FATURA ADD COLUMN data_autorizacao DATETIME NULL;

ALTER TABLE TB_COMPRA ADD COLUMN data_autorizacao DATETIME NULL;
ALTER TABLE TB_COMPRA ADD COLUMN data_pagamento DATETIME NULL;

ALTER TABLE TB_COMPRA ADD COLUMN autorizado BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE TB_COMPRA ADD COLUMN encerrado BOOLEAN NOT NULL DEFAULT FALSE;
...
ALTER TABLE TB_CAMPI DROP COLUMN num_inscricao;

ALTER TABLE TB_PROJETO ADD COLUMN data_criacao DATETIME NOT NULL DEFAULT NOW();
ALTER TABLE TB_PROJETO ADD COLUMN data_analise DATETIME NULL;
ALTER TABLE TB_PROJETO ADD COLUMN data_aprovacao DATETIME NULL;
ALTER TABLE TB_PROJETO ADD COLUMN data_conclusao DATETIME NULL;
ALTER TABLE TB_PROJETO ADD COLUMN data_suspenso DATETIME NULL;

ALTER TABLE TB_ORCAMENTO ADD COLUMN data_criacao DATETIME NOT NULL DEFAULT NOW();
ALTER TABLE TB_ORCAMENTO ADD COLUMN data_analise DATETIME NULL;
ALTER TABLE TB_ORCAMENTO ADD COLUMN data_conclusao DATETIME NULL;
